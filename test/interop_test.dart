...
class Side extends ProtobufEnum {
  ...
  const Side._(super.v, super.n);
}

class Order extends GeneratedMessage {
  static final BuilderInfo _i =
      BuilderInfo('Order', package: const PackageName('bench'))
        ...
        ..e<Side>(5, 'side', PbFieldType.OE,
            defaultOrMaker: Side.SIDE_BUY,
...
class Fill extends GeneratedMessage {
  static final BuilderInfo _i =
      BuilderInfo('Fill', package: const PackageName('bench'))
...
void main() {
  test('SBE binary interop with Go', () {
    ...
    const expectedHex =
        '2a0001000100000039300000000000004141504c00000000ca3a000000000000640000000101000000000000f83f0000904014000100cf3a000000000000320000000100000000000000';
  ...
  test('PB binary interop with Go', () {
    ...
    const expectedHex =
        '0a05416c696365101e19000000000060504020012a0561646d696e2a0475736572';
