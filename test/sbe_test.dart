...
class Order extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Order', package: const PackageName('test'))
...
class Header extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Header', package: const PackageName('test'))
...
class Fill extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Fill', package: const PackageName('test'))
  ...
  group('SBE Codec', () {
    ...
    test('marshal and unmarshal with composite and groups', () {
      ...
      (order.getField(4) as List<Fill>).addAll([
        Fill()..setField(1, 150.5)..setField(2, 10),
        Fill()..setField(1, 151.0)..setField(2, 20),
      ]);
