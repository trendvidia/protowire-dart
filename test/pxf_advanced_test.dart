...
class OneofMessage extends GeneratedMessage {
  static final BuilderInfo _i =
      BuilderInfo('OneofMessage', package: const PackageName('test'))
        ..aOS(1, 'name')
        ..oo(0, [2, 3])
        ..aOS(2, 'stringVal')
...
class AnyContainer extends GeneratedMessage {
  static final BuilderInfo _i =
      BuilderInfo('AnyContainer', package: const PackageName('test'))
...
class Payload extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Payload',
      package: const PackageName('test'), createEmptyInstance: () => Payload())
    ..aOS(1, 'data')
    ..hasRequiredFields = false;
...
class BigNumContainer extends GeneratedMessage {
  static final BuilderInfo _i =
      BuilderInfo('BigNumContainer', package: const PackageName('test'))
  ...
  group('PXF Advanced Features', () {
    test('oneof exclusivity', () {
      ...
      expect(
          () => unmarshal(input, msg),
          throwsA(predicate((e) =>
              e.toString().contains('conflicts with already-set field'))));
    });
