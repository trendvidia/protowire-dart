...
class FeatureSet_ProtoLimitsFeature_EnforceProtoLimits
    extends $pb.ProtobufEnum {
  static const FeatureSet_ProtoLimitsFeature_EnforceProtoLimits
      PROTO_LIMITS_UNKNOWN = FeatureSet_ProtoLimitsFeature_EnforceProtoLimits._(
          0, _omitEnumNames ? '' : 'PROTO_LIMITS_UNKNOWN');
  ...
  static const FeatureSet_ProtoLimitsFeature_EnforceProtoLimits
      ...
      FeatureSet_ProtoLimitsFeature_EnforceProtoLimits._(
          1, _omitEnumNames ? '' : 'LEGACY_NO_EXPLICIT_LIMITS');
  ...
  static const FeatureSet_ProtoLimitsFeature_EnforceProtoLimits
      PROTO_LIMITS2026 = FeatureSet_ProtoLimitsFeature_EnforceProtoLimits._(
          2, _omitEnumNames ? '' : 'PROTO_LIMITS2026');

  static const $core.List<FeatureSet_ProtoLimitsFeature_EnforceProtoLimits>
      values = <FeatureSet_ProtoLimitsFeature_EnforceProtoLimits>[
    PROTO_LIMITS_UNKNOWN,
    LEGACY_NO_EXPLICIT_LIMITS,
    PROTO_LIMITS2026,
  ];

  static final $core.List<FeatureSet_ProtoLimitsFeature_EnforceProtoLimits?>
      _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static FeatureSet_ProtoLimitsFeature_EnforceProtoLimits? valueOf(
          $core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const FeatureSet_ProtoLimitsFeature_EnforceProtoLimits._(
      super.value, super.name);
}
