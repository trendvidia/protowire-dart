...
class FeatureSet_ProtoLimitsFeature extends $pb.GeneratedMessage {
  ...
  FeatureSet_ProtoLimitsFeature._();

  factory FeatureSet_ProtoLimitsFeature.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory FeatureSet_ProtoLimitsFeature.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FeatureSet.ProtoLimitsFeature',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FeatureSet_ProtoLimitsFeature clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FeatureSet_ProtoLimitsFeature copyWith(
          void Function(FeatureSet_ProtoLimitsFeature) updates) =>
      super.copyWith(
              (message) => updates(message as FeatureSet_ProtoLimitsFeature))
          as FeatureSet_ProtoLimitsFeature;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FeatureSet_ProtoLimitsFeature create() =>
      FeatureSet_ProtoLimitsFeature._();
  @$core.override
  FeatureSet_ProtoLimitsFeature createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static FeatureSet_ProtoLimitsFeature getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FeatureSet_ProtoLimitsFeature>(create);
...
class FeatureSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<FeatureSet_ProtoLimitsFeature_EnforceProtoLimits>(
        9, _omitFieldNames ? '' : 'enforceProtoLimits',
        enumValues: FeatureSet_ProtoLimitsFeature_EnforceProtoLimits.values)
    ..hasExtensions = true;
  ...
  @$pb.TagNumber(9)
  FeatureSet_ProtoLimitsFeature_EnforceProtoLimits get enforceProtoLimits =>
      $_getN(8);
  @$pb.TagNumber(9)
  set enforceProtoLimits(
          FeatureSet_ProtoLimitsFeature_EnforceProtoLimits value) =>
      $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasEnforceProtoLimits() => $_has(8);
  @$pb.TagNumber(9)
  void clearEnforceProtoLimits() => $_clearField(9);
}
