...
void _writeProtoMessage(
    StringBuffer sb,
    XMLMessage msg,
    Map<String, XMLType> typeMap,
    Map<String, XMLComposite> compositeMap,
    Map<String, XMLEnum> enumMap,
    String indent) {
